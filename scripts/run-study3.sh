...
#
# Usage:
#   scripts/run-study3.sh [--model MODEL] [--limit N] [--dry-run]
#   scripts/run-study3.sh --model meta-llama/Llama-3.3-70B-Instruct-Turbo --limit 10
#
# Env:
...
if [[ -n "${TOGETHER_API_KEY:-}" ]]; then
  ...
  echo "[study3] using Together.ai model: $OPENAI_MODEL"
