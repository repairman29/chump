...
# Usage: ./scripts/ollama-unload-models.sh [model1 model2 ...]
...
echo "Done. If RAM is still high, Ollama often keeps memory until restarted. Run ./scripts/ollama-restart.sh to fully free it."
