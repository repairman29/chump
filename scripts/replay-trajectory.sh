...
#
# Usage:
#   scripts/replay-trajectory.sh                    # all fixtures
#   scripts/replay-trajectory.sh 001-read-then-patch  # one fixture by id-prefix
#   scripts/replay-trajectory.sh --json             # machine-readable output
#
# Env:
