...
#
# Usage:
#   ./scripts/setup/install-roles-launchd.sh              # use CHUMP_HOME or script dir/..
#   CHUMP_HOME=/Users/you/Projects/Chump ./scripts/setup/install-roles-launchd.sh
#
...
echo "To stop: ./scripts/setup/unload-roles-launchd.sh"
