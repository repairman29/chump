...
#
# Usage:
#   scripts/setup/ollama-watchdog.sh                      # one-shot check
#   scripts/setup/ollama-watchdog.sh --loop               # daemon mode, 30s tick
#   scripts/setup/ollama-watchdog.sh --loop --no-restart  # detect-only (paging)
#   scripts/setup/ollama-watchdog.sh --help
#
# Env:
