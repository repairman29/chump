...
# INFRA-1789: golden-file diff of `chump preflight --help` against
# crates/chump-preflight/tests/help-golden.txt — catches wording/flag drift
# that chump-help-regression's presence-only check misses.
