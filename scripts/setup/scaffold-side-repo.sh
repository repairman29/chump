...
#
# Usage:
#   ./scripts/setup/scaffold-side-repo.sh /path/to/new-repo "Human readable name"
#   ./scripts/setup/scaffold-side-repo.sh /path/to/new-repo "My Project" --git   # git init + first commit
#
