...
nohup env VLLM_MODEL="$VLLM_MODEL" VLLM_MAX_NUM_SEQS="$VLLM_MAX_NUM_SEQS" VLLM_MAX_TOKENS="$VLLM_MAX_TOKENS" VLLM_CACHE_PERCENT="$VLLM_CACHE_PERCENT" PORT=8001 "$ROOT/scripts/setup/serve-vllm-mlx-8001.sh" >>"$ROOT/logs/vllm-mlx-8001.log" 2>&1 &
