...
#
# After this, run servers with: ./serve-vllm-mlx.sh (14B on 8000), ./scripts/setup/serve-vllm-mlx-8001.sh (7B on 8001), etc.
...
# Chump mix: main (14B), worker/fast (7B), small (3B). Override with space-separated env:
# CHUMP_MLX_MODELS="mlx-community/Qwen2.5-7B-Instruct-4bit" ./scripts/setup/download-mlx-models.sh
MODELS=(${CHUMP_MLX_MODELS:-mlx-community/Qwen2.5-14B-Instruct-4bit mlx-community/Qwen2.5-7B-Instruct-4bit mlx-community/Qwen2.5-3B-Instruct-4bit})
...
echo "Done. All models cached. Start servers with: ./serve-vllm-mlx.sh (8000), ./scripts/setup/serve-vllm-mlx-8001.sh (8001), etc."
