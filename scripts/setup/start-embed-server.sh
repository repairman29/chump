...
# Requires: pip install -r scripts/setup/requirements-embed.txt (use a venv on Homebrew Python — see README).
...
exec "$PYTHON" scripts/setup/embed_server.py --port "$PORT"
