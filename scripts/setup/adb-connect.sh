#!/usr/bin/env bash
# scripts/setup/adb-connect.sh — Connect to wireless ADB device (e.g. after reboot).
#
# Usage:
#   ./scripts/setup/adb-connect.sh              # use CHUMP_ADB_DEVICE from .env
#   ./scripts/setup/adb-connect.sh 10.1.10.9:34085   # connect to this address
#
