...
#
# Usage:
#   ./scripts/setup/deploy-mac.sh           # build + restart Discord + Web
#   ./scripts/setup/deploy-mac.sh --discord # restart Discord bot only
#   ./scripts/setup/deploy-mac.sh --web     # restart Web bot only
#   ./scripts/setup/deploy-mac.sh --build-only  # just build; don't restart anything
#
# Env overrides:
...
log "deploy-mac: done."
echo ""
echo "Run ./scripts/dev/fleet-health.sh to verify both bots are healthy."
