...
# CREDIBLE-284: `gap reserve` no longer auto-fills a placeholder AC, and P0/P1
# now REQUIRES --acceptance-criteria unless --no-ac-required bypasses it. Use
# the bypass here since this fixture deliberately wants a vague/empty-AC gap.
