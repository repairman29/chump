...
echo "4. Set CHUMP_INFERENCE_BACKEND=mistralrs + CHUMP_MISTRALRS_MODEL per docs/operations/INFERENCE_PROFILES.md §2b"
...
echo ""
echo "Note: turns that register tools skip this constraint (see docs/architecture/ADR-002-mistralrs-structured-output-spike.md)."
echo ""
echo "=== Compile + unit tests (mistralrs_provider) ==="
exec ./scripts/ci/check-mistralrs-infer-build.sh
