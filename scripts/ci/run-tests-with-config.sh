...
#
# Usage:
#   ./scripts/ci/run-tests-with-config.sh <profile> <test_script> [args...]
#   ./scripts/ci/run-tests-with-config.sh default battle-qa.sh
#   ./scripts/ci/run-tests-with-config.sh max_m4 battle-qa.sh BATTLE_QA_MAX=50
#   ./scripts/ci/run-tests-with-config.sh default run-autonomy-tests.sh
#
