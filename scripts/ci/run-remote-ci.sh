...
run_test_script "$SCRIPTS_CI/test-gap-already-satisfied.sh"
...
run_test_script "$SCRIPTS_CI/test-dashboard-snapshot-concurrent.sh"
...
run_test_script "$SCRIPTS_CI/test-infra-watcher-pty-check.sh"
