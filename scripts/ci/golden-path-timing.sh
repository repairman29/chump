...
#   GOLDEN_TIMING_HIT_HEALTH=1 ./scripts/ci/golden-path-timing.sh   # requires web already on CHUMP_WEB_HOST:PORT
#   GOLDEN_TIMING_INCLUDE_TEST=1 ./scripts/ci/golden-path-timing.sh
#
