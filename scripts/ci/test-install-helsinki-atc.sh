...
for unit in chump-pr-lander chump-armed-rebaser chump-board-cycle chump-sla-scorecard; do
...
ok "all 4 system-unit organs (pr-lander, armed-rebaser, board-cycle, sla-scorecard) have tracked .service+.timer pairs"
