...
# Usage: from repo root: ./scripts/daily-driver-preflight.sh
# CHUMP_PREFLIGHT_WEB_PORT (default 3847) — intentional E2E/preflight port; ./run-web.sh still defaults 3000 for daily dev.
# To see what URL automation would pick: ./scripts/print-chump-web-base.sh
...
./scripts/build-chump-menu.sh >/dev/null || fail "build-chump-menu"
