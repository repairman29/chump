...
#
# Usage:
#   ./scripts/chump-bench.sh                       # all scenarios
#   ./scripts/chump-bench.sh --scenario chat       # one scenario by name
#   ./scripts/chump-bench.sh --list                # print the scenario set
#   ./scripts/chump-bench.sh --interactive-budget-s 45  # tune the "fast" threshold
#
# Exit:
