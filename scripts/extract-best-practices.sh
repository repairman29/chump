...
#
# Usage:
#   scripts/extract-best-practices.sh [--output-dir <dir>]
#
# Output:
...
L += [
    ...
    "",
    "> Auto-generated by `scripts/extract-best-practices.sh` (PRODUCT-008).",
...
if pr_count > 0 and small_pr_pct < 60:
    props_claude.append(
        ...
        "Consider a pre-push warning in `scripts/bot-merge.sh` when `changedFiles > 5`."
    )
...
L += [
    ...
    "---",
    "",
    f"_Generated: {today} · `scripts/extract-best-practices.sh` · PRODUCT-008_",
]
