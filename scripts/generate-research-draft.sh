...
#
# Reads logs/study-analysis.json and produces docs/archive/2026-04/briefs/CONSCIOUSNESS_AB_RESULTS.md.
...
export OUTPUT="$ROOT/docs/archive/2026-04/briefs/CONSCIOUSNESS_AB_RESULTS.md"
