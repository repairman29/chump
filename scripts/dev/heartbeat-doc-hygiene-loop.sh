...
#
# Shared prompt: scripts/eval/doc-hygiene-round-prompt.bash (same as heartbeat-self-improve.sh doc_hygiene rounds).
#
# Usage:
#   ./scripts/dev/heartbeat-doc-hygiene-loop.sh
#   HEARTBEAT_DURATION=2h HEARTBEAT_INTERVAL=15m ./scripts/dev/heartbeat-doc-hygiene-loop.sh
#   HEARTBEAT_QUICK_TEST=1 ./scripts/dev/heartbeat-doc-hygiene-loop.sh
#
