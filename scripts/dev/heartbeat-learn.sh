...
#
# Usage:
#   ./scripts/dev/heartbeat-learn.sh                    # 8h, round every 45 min
#   HEARTBEAT_DURATION=4h HEARTBEAT_INTERVAL=30m ./scripts/dev/heartbeat-learn.sh
#   HEARTBEAT_QUICK_TEST=1 ./scripts/dev/heartbeat-learn.sh   # 2m, 15s interval (quick validation)
#   HEARTBEAT_RETRY=1 ./scripts/dev/heartbeat-learn.sh        # retry once per round on failure
#
