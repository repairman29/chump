...
#
# Usage:
#   scripts/dev/ambient-query.sh <kind> [--since Nh]
#
# Examples:
#   scripts/dev/ambient-query.sh ALERT
#   scripts/dev/ambient-query.sh file_edit --since 1h
#   scripts/dev/ambient-query.sh commit --since 24h
#   scripts/dev/ambient-query.sh session_start --since 2h
#
# Arguments:
