...
#
# Usage:
#   ./scripts/dev/fleet-health.sh           # check Mac + Pixel
#   ./scripts/dev/fleet-health.sh --mac     # Mac only
#   ./scripts/dev/fleet-health.sh --pixel   # Pixel only
#   ./scripts/dev/fleet-health.sh --watch   # loop every 30s until all pass (or Ctrl-C)
#
