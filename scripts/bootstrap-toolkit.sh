...
#        SKIP_CARGO=1 ./scripts/bootstrap-toolkit.sh   # skip cargo installs (slow)
#        SKIP_BREW=1 ./scripts/bootstrap-toolkit.sh     # skip brew installs
#        INCLUDE_OLLAMA=1 ./scripts/bootstrap-toolkit.sh # also install ollama
...
echo "Run ./scripts/verify-toolkit.sh to check what's available."
