...
# Then from Mac:       ./scripts/run-setup-via-ssh.sh [termux_user@]pixel_ip
#
# Examples:
#   ./scripts/run-setup-via-ssh.sh u0_a284@10.1.10.9
#   TERMUX_USER=u0_a284 PIXEL_IP=10.1.10.9 ./scripts/run-setup-via-ssh.sh
