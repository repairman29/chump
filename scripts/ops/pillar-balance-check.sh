...
# Ensure ambient directory exists (AC fix: mkdir -p dirname before >> append)
...
# Calculate total pickable (pillar-tagged only)
...
for pillar in EFFECTIVE CREDIBLE RESILIENT ZERO-WASTE; do
    ...
    # Alert: Pillar overweight (> 50% of total pickable)
