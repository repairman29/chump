...
#   docs/archive/2026-04/briefs/CONSCIOUSNESS_AB_RESULTS.md  — draft research report
...
echo "  docs/archive/2026-04/briefs/CONSCIOUSNESS_AB_RESULTS.md"
echo ""
echo "Next: Review docs/archive/2026-04/briefs/CONSCIOUSNESS_AB_RESULTS.md and edit for publication."
