...
#   CHUMP_TAIL_LOGS="logs/battle-pwa-live.log,logs/discord.log" ./scripts/tail-model-dogfood.sh
#
...
if [[ ${#paths[@]} -eq 0 ]]; then
  ...
  echo "  • Battle QA: BATTLE_QA_MAX=5 ./scripts/battle-qa.sh  → logs/battle-qa.log" >&2
