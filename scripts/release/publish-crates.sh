...
#
# Usage:
#   scripts/release/publish-crates.sh                      # dry-run only (default — safe)
#   scripts/release/publish-crates.sh --execute            # actually publish (after dry-run passes)
#   scripts/release/publish-crates.sh --only chump-perception   # one crate, dry-run
#   scripts/release/publish-crates.sh --only chump-perception --execute
#
# Order:
