...
#
# Usage:
#   ./scripts/active-target-reaper.sh              # default: --dry-run
#   ./scripts/active-target-reaper.sh --execute    # actually purge
#   ./scripts/active-target-reaper.sh --execute --age-days 14
#
# Install hourly via launchd:
#   ./scripts/install-active-target-reaper-launchd.sh
