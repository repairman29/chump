...
#
# Usage:
#   scripts/run-neuromod-study.sh                     # full run (default model)
#   scripts/run-neuromod-study.sh --dry-run           # preview
#   scripts/run-neuromod-study.sh --model qwen3:8b    # override model
#   scripts/run-neuromod-study.sh --fixture <path>    # custom fixture
#
# Env:
...
scripts/populate-paper-section33.sh "$RESULTS_JSON" 2>/dev/null || \
