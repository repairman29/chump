...
Usage:
  ...
  ./scripts/build-white-papers.py --docker
  ./scripts/build-white-papers.py --chrome-pdf
  ./scripts/build-white-papers.py --volume volume-1-showcase
  ./scripts/build-white-papers.py --html-only
  ./scripts/build-white-papers.py --profile academic
  ./scripts/build-white-papers.py --merge
  ./scripts/build-white-papers.py --dry-run
    ...
    *,
    ...
    lines = [
        ...
        *(("  (none — build may have failed)",) if not names else ()),
        ...
        "",
        "Regenerate: ./scripts/build-white-papers.py --docker",
        "",
    ]
...
def main() -> int:
    ...
    if args.dry_run:
        ...
        if engine is None and not html_only:
            ...
            print("Or: ./scripts/build-white-papers.py --docker", file=sys.stderr)
            print("Or: ./scripts/build-white-papers.py --chrome-pdf", file=sys.stderr)
            print("Or: ./scripts/build-white-papers.py --html-only", file=sys.stderr)
            return 1
    else:
