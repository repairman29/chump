...
2. run_cli "./scripts/dev/doc-keeper.sh" — if it exits non-zero, fix **broken relative Markdown links** and re-run until it passes (or you hit 3 doc-keeper attempts; then episode log and notify with remaining failures).
...
**Verify:** After edits, run_cli "./scripts/dev/doc-keeper.sh" again (DOC_KEEPER_STALE_SCAN=0 is default).
