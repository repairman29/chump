...
#
# COG-001 acceptance: "scripts/eval/run-consciousness-study.sh produces a results JSON
...
#
# Usage:
#   scripts/eval/run-multi-model-study.sh                      # full sweep
#   scripts/eval/run-multi-model-study.sh --dry-run            # preview
#   scripts/eval/run-multi-model-study.sh --models qwen2.5:7b  # single model
#   scripts/eval/run-multi-model-study.sh --fixture <path>     # custom fixture
#
# Env:
...
scripts/setup/populate-paper-section4.sh "$RESULTS_JSON" 2>/dev/null || \
