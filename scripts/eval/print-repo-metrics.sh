...
#
# Usage:
#   ./scripts/eval/print-repo-metrics.sh           # human-readable Markdown block
...
**Cold path / evidence:** [docs/process/EXTERNAL_GOLDEN_PATH.md](docs/process/EXTERNAL_GOLDEN_PATH.md), \`./scripts/ci/verify-external-golden-path.sh\`, [docs/process/ONBOARDING_FRICTION_LOG.md](docs/process/ONBOARDING_FRICTION_LOG.md).
