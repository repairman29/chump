...
#
# Usage:
#   ./scripts/eval/dogfood-run.sh                    # pick next task from queue
#   ./scripts/eval/dogfood-run.sh "fix clippy warning in src/foo.rs"  # one-shot prompt
#
# Prerequisites:
...
# "OPENAI_MODEL=foo CHUMP_OLLAMA_NUM_CTX=16384 ./scripts/eval/dogfood-run.sh ..." works.
