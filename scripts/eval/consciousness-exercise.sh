...
# Override: CHUMP_EXERCISE_MODEL=llama3.2:3b  CHUMP_EXERCISE_TIMEOUT=240  ./scripts/eval/consciousness-exercise.sh
...
echo ""
bash "$ROOT/scripts/eval/consciousness-report.sh"
echo ""
echo "=== Capturing AFTER baseline ==="
bash "$ROOT/scripts/eval/consciousness-baseline.sh"
