...
After grading, append a section to `docs/research/CONSCIOUSNESS_AB_RESULTS.md` with the comparison table. This unblocks COG-014 (task-specific lessons) — the next experiment that needs trustworthy A/B measurement to validate.
