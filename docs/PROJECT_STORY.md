...
Mutual supervision (each machine monitors the other's heartbeat) is implemented. The full fleet coordination spec is in [docs/AGENT_COORDINATION.md](AGENT_COORDINATION.md).
