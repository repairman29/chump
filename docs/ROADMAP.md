...
- [ ] **P5 — Product polish** — **P5.3** parity matrix; **P5.4** turn_error copy; **P5.1** onboarding (partial: PWA bar + Settings quick setup); **P5.2** mobile pass (matrix + touch CSS — see [UI_MANUAL_TEST_MATRIX_20.md](UI_MANUAL_TEST_MATRIX_20.md)); **P5.5** signed/notarized distribution.
