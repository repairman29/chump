...
./scripts/eval/run-consciousness-study.sh
```
...
*Generated by `scripts/eval/generate-research-draft.sh` — edit before publishing.*
...
> **Run:** `bash scripts/eval/recall-benchmark.sh`
...
The other agent's `scripts/eval/run-multi-model-study.sh` (in worktree
