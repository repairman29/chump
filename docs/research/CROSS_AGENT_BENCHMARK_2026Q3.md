...
> Methodology follows `docs/process/RESEARCH_INTEGRITY.md`.
...
Both judges are required per `docs/process/RESEARCH_INTEGRITY.md` §2 ("at least one non-Anthropic
...
current architecture is sub-optimal. The mechanism drilldown (per `docs/process/RESEARCH_INTEGRITY.md`
...
3. **Tool-call hallucination detection.** `scoring_v2.HALLUCINATION_PATTERNS` was
   ...
   before citing hallucination rates (per `docs/process/RESEARCH_INTEGRITY.md` §3).
...
- [`docs/process/RESEARCH_INTEGRITY.md`](RESEARCH_INTEGRITY.md) — required methodology standards
- [`docs/research/CONSCIOUSNESS_AB_RESULTS.md`](CONSCIOUSNESS_AB_RESULTS.md) — existing Chump self-benchmark results
