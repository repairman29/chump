...
Reading `docs/audits/FINDINGS.md`, `docs/process/RESEARCH_INTEGRITY.md`, and the ~60 EVAL-*
...
Everything else labeled COVERED+VALIDATED(NULL) in `docs/architecture/CHUMP_FACULTY_MAP.md`
...
established by `docs/research/RESEARCH_PLAN_2026Q3.md`.
