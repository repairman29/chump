...
`docs/architecture/CHUMP_FACULTY_MAP.md` (shipped 2026-04-19) showed that **only 4 of 10
...
- A/B sweep is published in `docs/research/CONSCIOUSNESS_AB_RESULTS.md` with cross-
...
- `docs/architecture/CHUMP_FACULTY_MAP.md` — current faculty status
- `docs/archive/2026-04/STRATEGY_VS_GOOSE.md` — competitive positioning (archived)
- `docs/research/CONSCIOUSNESS_AB_RESULTS.md` — published findings
