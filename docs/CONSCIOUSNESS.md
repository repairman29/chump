...
> judge re-runs (EVAL-042 series) ship. See `docs/RESEARCH_INTEGRITY.md`.
...
All result citation requires cross-family judge validation per `docs/RESEARCH_INTEGRITY.md`.
