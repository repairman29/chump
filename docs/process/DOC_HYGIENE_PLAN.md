...
| Doc | Currently | After |
|---|---|---|
| `docs/archive/strategy-2026-04/ROADMAP-superseded.md` open-gaps section | hand-edited | `chump gap list --status open --format roadmap-md` regenerated by gardener |
...
- [ ] This plan committed at `docs/process/DOC_HYGIENE_PLAN.md` with phase definitions
...
- `docs/audits/RED_LETTER.md` — source of the "143 docs" critique
- `memory/project_doc_infrastructure.md` — daily gardener / hourly tech
  writer / on-demand journalist roles
- `docs/process/MD_BOOK_PUBLISH_SURFACE.md` — current sync rules between
  `docs/` and `book/src/`
- `docs/strategy/WORLD_CLASS_ROADMAP.md` M5 — "metrics + auto-route by gap class" —
