...
See `docs/research/CONSCIOUSNESS_AB_RESULTS.md` ("Per-model opt-in policy table (post-COG-024)") for the canonical table mapping each model to its validated lessons variant and the EVAL gap that justifies it.
