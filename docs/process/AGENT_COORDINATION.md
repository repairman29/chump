...
```json
{
  ...
  "paths": [
    "docs/process/AGENT_COORDINATION.md",
    "AGENTS.md",
    "docs/gaps.yaml"
  ],
...
**Setup:** `docs/process/MERGE_QUEUE_SETUP.md`. The queue is enabled on `main` via the
...
If `mergeQueue` returns `null`, the UI step in `docs/process/MERGE_QUEUE_SETUP.md` was
