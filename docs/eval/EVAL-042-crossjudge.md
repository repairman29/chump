...
`docs/research/CONSCIOUSNESS_AB_RESULTS.md` up through EVAL-029 used `claude-sonnet-4-5` as sole judge
...
`docs/process/RESEARCH_INTEGRITY.md`, using the COG-016 production block.
...
"unconfirmed pending judge calibration" in `docs/research/CONSCIOUSNESS_AB_RESULTS.md`.
