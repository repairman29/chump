...
| [ROADMAP_MABEL_DRIVER.md](ROADMAP_MABEL_DRIVER.md) | **Mabel as a driver:** autonomous heartbeat (patrol, research, report, intel, peer_sync), unified reporting, Termux:Boot, ChumpMenu start/stop |
