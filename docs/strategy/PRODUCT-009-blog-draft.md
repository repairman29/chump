...
**Registry:** `PRODUCT-009` is **`status: open`** again as of 2026-04-22 — the gap was mistakenly closed before acceptance (no live URL in `docs/audits/FINDINGS.md`, `closed_pr` was `TBD`). This draft still has to clear the acceptance rows.  
**Status:** Draft — pending external review before publication  
**Word count:** ~2,100  
**Reviewed against:** `docs/process/RESEARCH_INTEGRITY.md` (2026-04-20)  
...
*Draft status: pending external review (Gemini architectural reviewer) before final publication. Not yet live. When published, URL will be added to docs/audits/FINDINGS.md "How to cite" section.*
