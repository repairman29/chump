...
1. **Source of truth stays in git** — `docs/ROADMAP.md` (current roadmap; the file previously named here, `docs/archive/strategy-2026-04/ROADMAP-superseded.md`, is now an intentionally-archived historical snapshot), `CHUMP_PROJECT_BRIEF.md`, `AGENTS.md`, code. Cleaning `target/` does not touch that.
...
4. **Schedule:** Calendar reminder (e.g. quarterly) or tie to a Phase reconciliation checkpoint in [`docs/ROADMAP.md`](https://github.com/repairman29/chump/blob/main/docs/ROADMAP.md).
