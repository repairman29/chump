...
- `docs/audits/FINDINGS.md` can stay **clean, citable, and uncluttered**, while still being
  honest.
...
claims aligned with `docs/process/RESEARCH_INTEGRITY.md`.
...
- **Primary policy**: `docs/process/RESEARCH_INTEGRITY.md` (Required Methodology Standards).
...
- **Update**: `docs/audits/FINDINGS.md` should be updated first (so public readers see the correction).
