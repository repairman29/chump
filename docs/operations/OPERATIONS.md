...
**What to work on:** The roadmap is **docs/strategy/ROADMAP.md** (prioritized goals; unchecked items = work to do). **docs/briefs/CHUMP_PROJECT_BRIEF.md** has focus and conventions. Heartbeat, Discord bot, and Cursor agents read these; edit ROADMAP.md to add or check off items.
