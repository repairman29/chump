...
| — | **RESEARCH-026** (observer-effect / eval-framing) | *pending* | Formal vs casual naturalized prompts on the reflection fixture — paired `task_id`, Wilson CIs, preregistered §9 | [`docs/eval/RESEARCH-026-observer-effect.md`](eval/RESEARCH-026-observer-effect.md) | Harness merged [PR #400](https://github.com/repairman29/chump/pull/400) 2026-04-21; **empirical sweep + Wilson row still open** (requires keys + prereg validation gate) |
