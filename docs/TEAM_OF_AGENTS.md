...
- `docs/AGENT_COORDINATION.md` — full coordination system spec
- `docs/RESEARCH_PLAN_2026Q3.md` — what we're building this quarter
- `docs/STRATEGY_VS_GOOSE.md` — competitive positioning
- `docs/CHUMP_FACULTY_MAP.md` — what's tested vs untested
