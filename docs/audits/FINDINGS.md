...
[`docs/process/RESEARCH_INTEGRITY.md` (source)](https://github.com/repairman29/chump/blob/main/docs/process/RESEARCH_INTEGRITY.md) ·
[`docs/architecture/CHUMP_FACULTY_MAP.md` (source)](https://github.com/repairman29/chump/blob/main/docs/architecture/CHUMP_FACULTY_MAP.md) ·
[`docs/research/RESEARCH_EXECUTION_LANES.md` (source)](https://github.com/repairman29/chump/blob/main/docs/research/RESEARCH_EXECUTION_LANES.md) (free-tier vs batched paid work)
...
[`docs/operations/OOPS.md` (source)](https://github.com/repairman29/chump/blob/main/docs/operations/OOPS.md).
...
**Source.** [Research paper](./research-paper.md)
Study 1. [`docs/research/CONSCIOUSNESS_AB_RESULTS.md`](./CONSCIOUSNESS_AB_RESULTS.md)
...
- **A/A noise-floor calibration as standard practice.** Every A/B sweep
  ...
  [`docs/process/RESEARCH_INTEGRITY.md`](./RESEARCH_INTEGRITY.md).
...
- **Adversarial internal review.** An automated "Red Letter" / cold-water
  ...
  integrity ([`docs/audits/RED_LETTER.md`](./RED_LETTER.md)). Issue #3
...
- **Multi-agent coordination via lease files.** Concurrent dispatched
  ...
  pattern. See
  [`docs/process/AGENT_COORDINATION.md`](./AGENT_COORDINATION.md).
- **Shipped-not-merely-claimed validation.** PR #224 (F6 production
  ...
  [`docs/architecture/CHUMP_FACULTY_MAP.md`](./CHUMP_FACULTY_MAP.md) "shipped-by-PR"
  citations.
...
[`docs/process/RESEARCH_INTEGRITY.md`](./RESEARCH_INTEGRITY.md) for the
...
Available at: https://github.com/repairman29/chump/blob/main/docs/audits/FINDINGS.md
Updated: 2026-04-20.
```
...
**Draft location:** [`docs/strategy/PRODUCT-009-blog-draft.md`](./PRODUCT-009-blog-draft.md)  
