...
| **Roadmap links** | `scripts/ci/roadmap-mdbook-links.py` rewrites `docs/archive/strategy-2026-04/ROADMAP-superseded.md` targets to GitHub blob URLs or in-nav `./chapter.md` links so the synced roadmap chapter does not emit dead local `.html` neighbors on Pages. |
...
2. For large `docs/archive/strategy-2026-04/ROADMAP-superseded.md` link edits: `python3 scripts/ci/roadmap-mdbook-links.py`.
