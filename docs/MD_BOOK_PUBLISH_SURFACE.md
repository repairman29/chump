...
- `book/src/operations.md` — **synced** from `docs/OPERATIONS.md`

### Architecture
- `book/src/architecture.md` — **book-authored** (not overwritten by sync script)
- `book/src/rust-infrastructure.md` — **synced** from `docs/RUST_INFRASTRUCTURE.md`
...
### Contributing
- `book/src/research-integrity.md` — **synced** from `docs/RESEARCH_INTEGRITY.md`
- `book/src/roadmap.md` — **synced** from `docs/ROADMAP.md`
...
| `docs/RESEARCH_INTEGRITY.md` | `book/src/research-integrity.md` |
