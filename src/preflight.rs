...
fn discover_test_scripts(repo_root: &std::path::Path) -> Vec<std::path::PathBuf> {
    ...
    let candidates = [
        ...
        // INFRA-902: pillar balance alert smoke — verifies pillar-balance-check.sh emits
        // pillar_balance_alert / pillar_balance_overweight events and gates audit-priorities.
