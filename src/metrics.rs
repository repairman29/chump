...
pub struct FleetMetrics {
    ...
    /// META-082: coordination-action cost tracking (route changes, lesson
    /// fetches, etc.) — see crate::coordination_cost.
    pub coordination_action_metrics: crate::coordination_cost::CoordinationCostMetrics,
}
