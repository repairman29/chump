...
pub struct FleetMetrics {
    ...
    /// META-082: coordination-action cost tracking (route decisions, lesson
    /// publish/fetch, etc.) — see `crate::coordination_cost`.
    pub coordination_costs: crate::coordination_cost::CoordinationCostSnapshot,
}
...
pub fn snapshot() -> FleetMetrics {
    ...
    FleetMetrics {
        ...
        coordination_costs: crate::coordination_cost::snapshot(),
    }
}
