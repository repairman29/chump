...
pub struct FleetMetrics {
    ...
    /// META-082: coordination-action cost tracking (route change, lesson
    /// fetch/publish, etc.) — see crate::coordination_cost.
    pub coordination_action_metrics: crate::coordination_cost::CoordinationCostSnapshot,
}
...
pub fn snapshot() -> FleetMetrics {
    ...
    FleetMetrics {
        ...
        coordination_action_metrics: crate::coordination_cost::snapshot(),
    }
}
