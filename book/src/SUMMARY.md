...
- [Quick Start (Golden Path)](./getting-started.md)
- [Operations Guide](./operations.md)

# Architecture

- [System Architecture](./architecture.md)
- [Rust Infrastructure](./rust-infrastructure.md)
...
- [The Instrument Was Wrong. The Null Is Real.](./chronicles/2026-04-20-instrument-null.md)
