...
|---|---|---|
| 3 | [The Instrument Was Wrong. The Null Is Real.](./2026-04-20-instrument-null.md) | Binary harness flaw discovered; Metacognition modules re-scored under LLM judge at n=50/cell — null confirmed; Social Cognition ceiling effect |
...
- [The Research Paper](../research-paper.md) — full methodology and current findings
- [Quick Start](../getting-started.md) — run me in under 30 minutes
- [Contribute to the Research](../research-community.md) — run your own experiments and add to the dataset
