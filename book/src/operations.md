...
**What to work on:** The roadmap is **docs/archive/strategy-2026-04/ROADMAP-superseded.md** (prioritized goals; unchecked items = work to do). **docs/briefs/CHUMP_PROJECT_BRIEF.md** has focus and conventions. Heartbeat, Discord bot, and Cursor agents read these; edit ROADMAP.md to add or check off items.
