...
4. **If anything fails:** `./scripts/ci/chump-preflight.sh` from the repo root, then [OPERATIONS.md](https://github.com/{{org}}/{{repo}}/blob/main/docs/operations/OPERATIONS.md).  
